...
def index_2(request):
    ...
    return render(request, 'akcel/index-2.html', context)
...
def index_3(request):
    ...
    return render(request, 'akcel/index-3.html', context)
...
def certificates(request):
    ...
    return render(request, 'akcel/certificates.html', context)
...
def coming_soon(request):
    ...
    return render(request, 'akcel/coming-soon.html', context)
...
def under_maintenance(request):
    ...
    return render(request, 'akcel/under-maintenance.html', context)
